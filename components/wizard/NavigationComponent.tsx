...
export default function NavigationComponent() {
    ...
    return (
        <div className={"flex flex-row justify-center gap-10"}>
            ...
            <button className={`rounded px-2 py-1.5 border-1 border-office-green-500 ${!isLastStep ? `bg-office-green-500 text-white` : `bg-office-gray-600 text-black`} transition-colors
            `}
                    onClick={useCallback(() => {
