...
export default function ProgressComponent() {
    ...
    return (
        <div className="w-full bg-office-gray-600 rounded-full bg-office-gray-600">
            <div className="bg-office-green-600 h-2.5 rounded-full transition-width ease-in-out duration-500"
