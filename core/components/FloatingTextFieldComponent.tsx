...
export default function FloatingTextFieldComponent(props: FloatingTextFieldComponentProps) {
    ...
    return (
        <div>
            ...
            <label htmlFor={`textField_${props.name}`}
                   className={`${props.classNameLabel} peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform
                    -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-office-green-600 peer-placeholder-shown:scale-100
