    ...
    return (
        <form id={"form"}
            ...
            <label htmlFor="message"
                ...
                sie weitere Anforderungen?</label><br></br> <a className="text-xs">(Bereits vorinstaliert Firefox, Chrome, LibreOffice, Gimp2, Discord, AdobeAcrobatReader, VLC Mediaplayer)</a>
