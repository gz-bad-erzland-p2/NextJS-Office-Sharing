    ...
    return (
        <form id={"form"} className={"w-full"}>
            <div id={"content"}>
                ...
                <div className={"mt-5 w-full"}>
                    <table className={"w-full"}>
                        ...
                        <tr>
                            <td colSpan={COL_SPAN}>*Vorort bezahlen</td>
                        ...
                        {HARDWARE_LIST.filter(item => filterHardware(item.enum)).map((item, index) => (
                            <tr key={index}
                                ...
                                <td className={"px-5 py-2 hidden md:block"}>
                                    ...
                                    <div
                                        className={"pt-2 mb-5"}>Betriebssystem: {OperatingSystemList.filter(os => os.enum === getOperatingSystemForHardware(item.enum)).map(item => item.name)}
                                    </div>
                                </td>
            ...
            <div className={"w-full flex flex-col items-end justify-end"}>
                <button type={"button"}
                        className={"text-white bg-office-green-500 text-center w-auto my-5 hover:bg-office-green-800 font-medium rounded-lg p-2 transition-colors ease-in-out"}
                        onClick={async () => {
