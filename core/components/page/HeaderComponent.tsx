            ...
            <div id="mobile_menu">
                ...
                <div className="flex flex-col">
                    ...
                    <Link onClick={toggleMenu} href="/login"
                        className="text-gray-800 m-3 text-center bg-slate-200 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 focus:outline-none">
                            Anmelden
                    </Link>
                    <Link onClick={toggleMenu} href="/signup" className="text-white m-3 mt-0 text-center bg-office-green-500 hover:bg-office-green-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 focus:outline-none">
                        Registrieren
                    </Link>
                </div>
            </div>
