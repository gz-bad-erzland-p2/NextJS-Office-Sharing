    ...
    return (
        <CenteredFormComponent onSubmit={submitHandler}>
            ...
            <div className={"flex flex-col items-center justify-center bg-white h-full md:w-1/2 w-full min-w-0 rounded-2xl drop-shadow-2xl px-5"}>
                ...
                />
                <button
                    form={"form"} type="submit" className="text-white bg-office-green-500 hover:bg-blue-800 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Registieren
                </button>
            </div>
