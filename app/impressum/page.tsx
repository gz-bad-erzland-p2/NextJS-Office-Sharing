export default function SupportMainPage() {
    return (
        <div className="w-full h-auto">
            <div
                className="flex justify-center mx-auto max-w-screen-xl mt-10 mb-10">
                <div className={"bg-white px-5 rounded-2xl"}>
                    ...
                    <br/>
                    Vertreter: Herr Holger Hoburg
                    <br/>
                    Waldorfstraße 2
                    <br/>
                    01023 Dresden
                    <br/>
                    Germany Telefon: 03708/123679
                    <br/>
                    E‑Mail: support@gz-bad-erzland-P2.de
                    <br/>
                    <br/>
                    USt-IdNr.: DE 123456789
                    Das Gemeindezentrum Bad Erzland ist eine Körperschaft
                    des
                    öffentlichen Rechts. Sie wird vertreten durch Herrn Sven
                    Gutfried.
                    ...
                    Bürgerservice / Wirtschaft – Herrn Sven Gutfried
                    <br/>
                    Telefon: 03708/123679

                    <h3>Technische Umsetzung & Betreuung</h3>
                    SecNet IT GmbH
                    <br/>
                    Dr.-Külz-Ring 19
                    <br/>
                    ...
                    die
                    Autoren, die sich auf Schäden materieller oder ideeller
                    Art
                    ...
                    der
                    Autoren kein nachweislich vorsätzliches oder grob
                    ...
                    Verantwortungsbereiches des Autors liegen, tritt eine
                    Haftungsverpflichtung ausschließlich in dem Fall in
                    Kraft,
                    in dem der Autor von den Inhalten Kenntnis hat, er sich
                    von
                    ihnen nicht ausdrücklich distanziert und es ihm
                    technisch
                    möglich und zumutbar wäre, die Nutzung im Falle
                    rechtswidriger Inhalte zu verhindern. Der Autor erklärt
                    daher ausdrücklich, dass zum Zeitpunkt der Linksetzung
                    die
                    entsprechenden verlinkten Seiten frei von illegalen
                    Inhalten
                    waren. Der Autor hat keinerlei Einfluss auf die aktuelle
                    und
                    zukünftige Gestaltung und auf die Inhalte der
                    gelinkten/verknüpften Seiten. Deshalb distanziert er
                    sich
                    hiermit ausdrücklich von allen Inhalten aller gelinkten
                    /verknüpften Seiten und machen sich diese unter keinen
                    Umständen zu Eigen. Diese Feststellung gilt für alle
                    innerhalb des eigenen Internetangebotes gesetzten Links
                    und
                    Verweise sowie für Fremdeinträge in vom Autor
                    eingerichteten
                    ...
                    <h4>Urheberrecht</h4>
                    Das Copyright für veröffentlichte, von Autoren selbst
                    erstellte Objekte bleibt allein bei den Autoren der
                    Seiten.
                    ...
                    ausdrückliche Zustimmung der Autoren nicht gestattet.
                    <br/>
                    <br/>
                </div>
            </div>
